...
class CanaryDeploymentManager:
    ...
    def route_request(
        self, champion_version: str = "v1.0", challenger_version: str = "v2.0-candidate"
    ) -> tuple[str, str]:
        ...
        logger.debug(
            ...
            extra={
                ...
                "role": role,
                "traffic_counts": self._traffic_counts,
            },
        )
    ...
    def get_traffic_metrics(self) -> dict[str, Any]:
        ...
        return {
            ...
            "actual_challenger_ratio": round(self._traffic_counts["challenger"] / total, 4)
            if total > 0
            else 0.0,
        }
