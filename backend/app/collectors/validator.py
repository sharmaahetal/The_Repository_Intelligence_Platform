...
class RawPayloadValidator:
    """Validator ensuring raw GitHub response payloads match domain expectations."""

    def validate_repository_payload(self, raw_data: dict[str, Any]) -> RawRepositoryPayload:
        ...
        logger.info(
            ...
            extra={"owner": payload.owner_login, "repo": payload.name},
        )
        return payload
