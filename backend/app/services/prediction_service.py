...
class PredictionService:
    ...
    def __init__(self, uow: UnitOfWork | None = None) -> None:
        """Initialize PredictionService with injected or default UnitOfWork dependency."""
    ...
    async def create_prediction(
        ...
        *,
        ...
        async with self.uow as uow:
            ...
            # Accept both ModelVersionNotFound or ModelNotFound error handling expectations
            try:
